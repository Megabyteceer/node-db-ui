...
export default class Select extends React.Component {
	...
	render() {
		...
		var downCaret = ReactDOM.div({style:{position:'absolute', right:0, top:0}}, renderIcon('caret-down'));
		
		return ReactDOM.span({style:{display:'inline-block',width:w, background:this.props.disabled?undefined:'#fff',borderRadius:4, verticalAlign:'middle', textAlign:'left', whiteSpace:'nowrap', overflow:'hidden'}, onBlur:this.onBlur},
			ReactDOM.div({style:this.props.style||style, className:this.props.disabled?'unclickable disabled':'clickable', onClick:this.toggle},
