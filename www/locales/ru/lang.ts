...
initDictionary({
	...
	'BACK': 'Назад',
	'ADM_ON_CHANGE_EVENT': 'onChange событие поля %',
	'ADM_VARS': 'Переменные:',
	...
	'ADM_HLP_4': ' - предыдущее значение поля при редактировании поля',
	'ADM_HLP_5': ' - параметры, заполняемые автоматически при создании связанной записи',
	...
	'REGISTRATION_EMAIL_SENT': 'На e-mail % отправлена ссылка для подтверждения регистрации. <a href="/login">Вход.</a>'
});
