<?php
$A = array(
'UPL_ERROW_WFN'=>'Ошибка загрузки файла. Недопустимое имя файла.',
...
'IMAGE_SHOULDBE'=>'Файл должен быть в фромате png, jpg, или gif.',
'FILE_NOT_UPLOADED'=>'Файл не получен.',
'TAKEN_APCU'=>'Взято из кеша APCU с ключом #%',
'CACHED_APCU'=>'Закешировано с ключом #%',
'CLIENT_ONLY_ON_SERVER'=>'Поле "%" не должно отправляться на сервер',
'FIELD_SHOULD_EMPTY'=>'Параметр "%" должен быть пустым.',
'APCU_CLEARED'=>'APCU кеш сервера очищен.',
'APCU_IS_DISABLED'=>'APCU кеш не включен.',
...
'RATING_FLD_NOEDIT'=>'поле рейтинга не подлежит редактированию.',
...
'CANT_CWITCH_TO_ADMIN'=>'Нельзя получить права супер админа.',
...
'RESET_MESSAGE'=>'На указанный e-mail отправлена ссылка для сброса пароля. <a href="/login.php">Вход.</a>',
...
'EMAIL_SENDED'=>'На e-mail % отправлена ссылка для подтверждения регистрации. <a href="/login.php">Вход.</a>',
'USER_NAME'=>'Имя',
'USER_EMAIL'=>'E-mail',
