...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./notify.js", "./stage.js", "../both-side-utils.js", "./loading-indicator.js", "./debug-panel.js", "./forms/list.js", "./user.js", "./modal.js", "./main-frame.js"], factory);
    }
    ...
    function myAlert(txt, isSucess, autoHide, noDiscardByBackdrop) {
        if (!modal_js_1.default.instance) {
            ...
            var modalId = modal_js_1.default.instance.show(R.div({ className: className }, txt), noDiscardByBackdrop);
            if (autoHide) {
                setTimeout(function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        ...
                        var body = R.span({ className: 'prompt-body' }, txt, R.div({ className: 'prompt-footer' }, noButton, R.button({
                            onClick: function () {
                                modal_js_1.default.instance.hide();
                                resolve(true);
