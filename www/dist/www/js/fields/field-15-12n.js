        ...
        Lookup1toNField.prototype.render = function () {
            ...
            if (this.state.creationOpened) {
                if (this.state.itemIdToEdit) {
                    body = R.div({ className: 'field-lookup-loading-icon-container' }, utils_js_1.renderIcon('cog fa-spin fa-2x'));
                }
                else {
