...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../events/forms_events.js", "../utils.js", "./admin-event-editor.js", "./admin-utils.js", "./field-admin.js"], factory);
    }
    ...
    var field_admin_js_1 = require("./field-admin.js");
    var showedNodeId;
        ...
        NodeAdmin.prototype.render = function () {
            ...
            if (bodyVisible) {
                ...
                if (!item) {
                    ...
                    }, utils_js_1.renderIcon('eye')), R.button({
                        className: 'clickable toolbtn admin-form-btn',
                ...
                }, utils_js_1.L('NODE_SETTINGS'), R.b({ className: "admin-form-header" }, node.tableName), R.span(null, '; (' + (node.matchName || item.name) + '); id: ' + nodeId), R.div({
