...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../forms/form-mixins.js", "../stage.js", "../user.js", "../utils.js", "./node-admin.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var form_mixins_js_1 = require("../forms/form-mixins.js");
    var stage_js_1 = require("../stage.js");
    var user_js_1 = require("../user.js");
    var utils_js_1 = require("../utils.js");
    var node_admin_js_1 = require("./node-admin.js");
    function check() {
        return R.span({
    ...
    var AdminRoleprevsForm = /** @class */ (function (_super) {
        ...
        AdminRoleprevsForm.prototype.render = function () {
            if (this.state && this.state.data) {
                ...
                }, utils_js_1.L('ADM_NODE_ACCESS')), node.matchName), R.table({
                    className: "admin-role-prevs-table"
                }, R.thead({
                    className: "admin-role-prevs-row-header"
                }, R.tr({
                    className: "admin-role-prevs-line"
                }, R.th(), R.th(null, utils_js_1.L('VIEW')), R.th(null, utils_js_1.L('CREATE')), R.th(null, utils_js_1.L('EDIT')), R.th(null, utils_js_1.L('DELETE')), node.draftable ? R.th(null, utils_js_1.L('PUBLISH')) : undefined)), R.tbody(null, lines)));
                ...
                return R.div({ className: "admin-role-prevs-body" }, nodeAdmin, body, R.div(null, saveButton, closeButton));
            }
            else {
