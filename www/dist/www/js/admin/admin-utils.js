...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../components/select.js", "../main-frame.js", "../utils.js"], factory);
    }
    ...
    function initIconsList(params) {
        ...
        for (var _i = 0, ruleList_1 = ruleList; _i < ruleList_1.length; _i++) {
            ...
            for (var _a = 0, _b = style.cssRules; _a < _b.length; _a++) {
                var rule = _b[_a];
                ...
                if (allNames.length) {
                    ...
                    iconsList.push({
                        name: R.span(null, utils_js_1.renderIcon(iconName), allNames.join(', ')),
                        value: iconName
                    });
                }
            }
