...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../modal.js", "../utils.js"], factory);
    }
    ...
    var AdminEventEditor = /** @class */ (function (_super) {
        ...
        function AdminEventEditor(props) {
            ...
            if (!CodeMirror) {
                (__syncRequire ? Promise.resolve().then(function () { return require("../libs/code-mirror.js"); }) : new Promise(function (resolve_1, reject_1) { require(["../libs/code-mirror.js"], resolve_1, reject_1); })).then(function (module) {
        ...
        AdminEventEditor.prototype.render = function () {
            ...
            var fields = this.props.node.fields.map(function (f, i) {
                ...
                }) : ''), R.b(null, f.fieldName), extName);
            });
            var functionName = this.props.node.tableName + (this.props.field ? '_' + this.props.field.fieldName + '_' : '_') + this.props.handler;
            return R.div({
                className: "left"
            }, R.h4(null, this.props.title), R.div({
                className: 'admin-events-editor-body'
            }, R.span({ className: 'monospace' }, (this.props.handler === 'onsave' ? 'async ' : ''), 'function ', R.b(null, functionName), '() {'), R.textarea({
                ref: this.getTextareaRef,
                className: "admin-events-editor-textarea",
                defaultValue: this.state.src
            }), R.span({ className: 'monospace' }, '}')), R.div({
                className: 'centralize'
            }, R.button({
                className: 'clickable default-button',
                onClick: modal_js_1.default.instance.hide
            }, utils_js_1.renderIcon('times'), utils_js_1.L('CANCEL')), R.button({
                className: 'clickable success-button',
                onClick: this.saveClick
            }, utils_js_1.renderIcon('floppy-o'), utils_js_1.L('SAVE'))), R.hr(), R.h4(null, utils_js_1.L('ADM_VARS')), R.b(null, 'this.rec_creation'), utils_js_1.L('ADM_HLP_1'), R.br(), R.b(null, 'this.rec_update'), utils_js_1.L('ADM_HLP_2'), R.br(), R.b(null, 'this.rec_ID'), utils_js_1.L('ADM_HLP_3'), R.br(), R.b(null, 'this.prev_value'), utils_js_1.L('ADM_HLP_4'), R.br(), R.b(null, 'this.linkedCreationParams'), utils_js_1.L('ADM_HLP_5'), R.br(), R.b(null, 'this.linkedFilter'), utils_js_1.L('ADM_HLP_6'), R.br(), R.b(null, 'this.isUserEdit'), utils_js_1.L('ADM_HLP_7'), R.hr(), R.h4(null, utils_js_1.L('ADM_FUNCTIONS')), R.p(null, 'this.fieldValue(fn); this.isFieldEmpty(fn); this.setFieldValue(fn,val); this.isFieldVisible(fn); this.focusField(fn); this.setFieldLabel(fn,val);', R.br(), 'this.hideField(fn); this.showField(fn); this.disableField(fn); this.enableField(fn); this.fieldAlert(fn, text, isSucess); ', R.br(), 'this.addLookupFilters(fn, filtersObject), this.hideFooter(), this.showFooter(), this.saveForm()'), R.hr(), R.h4(null, utils_js_1.L('ADM_FIELDS')), fields);
        };
