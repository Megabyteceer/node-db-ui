...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "js/entry.js", "react", "../admin/field-admin.js"], factory);
    }
    ...
    var FormTab = /** @class */ (function (_super) {
        ...
        FormTab.prototype.render = function () {
            ...
            return entry_js_1.R.div({ className: className }, (this.props.highlightFrame ? React.createElement(field_admin_js_1.default, { field: this.props.field, form: this.props.form, x: 13 }) : ''), this.props.fields);
        };
        return FormTab;
    }(react_1.Component));
