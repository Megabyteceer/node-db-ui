    ...
    utils_js_2.registerFieldClass(FIELD_7_Nto1, /** @class */ (function (_super) {
        ...
        EnumField.prototype.render = function () {
            ...
            if (this.props.isEdit) {
                ...
                var valLabel;
                if (value && value.name) {
                    valLabel = entry_js_1.R.span(null, value.name);
                }
                else {
                    valLabel = entry_js_1.R.span({
                ...
                }, iconPic, valLabel), entry_js_1.R.span({ className: 'field-lookup-right-block' }, entry_js_1.R.span({
                    className: 'field-lookup-caret'
                }, utils_js_1.renderIcon('caret-down')), clearBtn)), list);
            }
            else {
                return entry_js_1.R.span(null, iconPic, value.name);
            }
        };
        return EnumField;
