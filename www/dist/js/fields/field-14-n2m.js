...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "js/entry.js", "../utils.js", "../utils.js", "./field-lookup-mixins.js"], factory);
    }
    ...
    utils_js_2.registerFieldClass(FIELD_14_NtoM, /** @class */ (function (_super) {
            ...
            if (isEdit) {
                if (value) {
                    ...
                    if (this.state.extendedEditor) {
                        reorderButton = entry_js_1.R.button({
                    ...
                    buttons = entry_js_1.R.span({ className: 'field-lookup-right-block' }, additionalButtonsN2M, entry_js_1.R.button({
                    ...
                    }, utils_js_1.renderIcon('pencil')), entry_js_1.R.button({
                ...
                if (isEdit || value) {
                    ...
                    var body = entry_js_1.R.div({ key: key, ref: value ? function (ref) { refs[utils_js_1.UID(value)] = ref; } : undefined, className: isDrag ? 'lookup-n2m-item lookup-n2m-item-drag' : 'lookup-n2m-item' }, React.createElement(utils_js_1.getClassForField(FIELD_7_Nto1), {
                        field: field,
        ...
        LookupNtoMField.prototype.render = function () {
            ...
            return entry_js_1.R.div(null, lines);
        };
