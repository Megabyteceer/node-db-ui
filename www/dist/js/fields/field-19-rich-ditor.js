        ...
        RichEditorField.prototype.render = function () {
            ...
            if (this.props.isEdit) {
                ...
                if (!this.summerNoteIsInited) {
                    cog = entry_js_1.R.div(null, utils_js_1.renderIcon('cog fa-spin'));
                }
                return entry_js_1.R.div(null, cog, entry_js_1.R.iframe({ ref: function (r) { _this.viewportRef = r; }, allowFullScreen: true, sandbox: 'allow-scripts allow-forms allow-same-origin', style: style, src: 'rich-editor/index.html?iframeId=' + this.iframeId }));
            }
            else {
                return entry_js_1.R.div({ dangerouslySetInnerHTML: { __html: this.props.initialValue } });
            }
        };
