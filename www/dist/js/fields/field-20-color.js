...
(function (factory) {
    ...
    utils_js_1.registerFieldClass(FIELD_20_COLOR, /** @class */ (function (_super) {
        ...
        ColorField.prototype.render = function () {
            ...
            var preview = entry_js_1.R.div({ className: "field-color-input field-color-preview-bg" }, entry_js_1.R.div({ className: 'field-color-preview', style: { background: background } }));
            if (this.props.isEdit) {
                return entry_js_1.R.div(null, entry_js_1.R.input({ className: 'field-color-input field-color-input-picker', type: 'color', defaultValue: '#' + (this.state.color & 0xFFFFFF).toString(16), onChange: this.onChangeColor }), preview, entry_js_1.R.input({ className: 'field-color-input field-color-input-alpha-slider', type: 'range', min: 0, max: 255, value: this.state.alpha, onChange: this.onChangeAlpha }), entry_js_1.R.input({ className: 'field-color-input field-color-input-alpha-input', type: 'number', min: 0, max: 255, value: this.state.alpha, onChange: this.onChangeAlpha }));
            }
            else {
                return preview;
            }
