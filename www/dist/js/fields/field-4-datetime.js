...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "js/entry.js", "../libs/libs.js", "../utils.js", "../utils.js", "./field-mixins.js"], factory);
    }
    ...
    var dateFieldMixins = /** @class */ (function (_super) {
        ...
        dateFieldMixins.prototype.importReactDateTime = function () {
            ...
            if (!this.ReactDatetimeClass) {
                (__syncRequire ? Promise.resolve().then(function () { return __importStar(require('../libs/react-datetime.js')); }) : new Promise(function (resolve_1, reject_1) { require(['../libs/react-datetime.js'], resolve_1, reject_1); }).then(__importStar)).then(function (module) {
    ...
    utils_js_2.registerFieldClass(FIELD_4_DATETIME, /** @class */ (function (_super) {
        ...
        FieldDateTime.prototype.render = function () {
            ...
            if (this.props.isEdit) {
                ...
                }, React.createElement(this.ReactDatetimeClass, inputsProps1)), entry_js_1.R.div({
