...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "js/entry.js", "react", "../admin/field-admin.js", "../user.js", "../utils.js"], factory);
    }
    ...
    var FieldHelp = /** @class */ (function (_super) {
        ...
        FieldHelp.prototype.render = function () {
            ...
            if (this.state && this.state.hovered) {
                body = entry_js_1.R.div({ className: 'field-wrap-help field-wrap-help-open' }, this.props.text);
            }
            else {
                body = entry_js_1.R.div({ className: 'field-wrap-help' }, utils_js_1.renderIcon('question-circle'));
            }
            return entry_js_1.R.div({ onMouseOver: this.mouseOver, onMouseOut: this.mouseOut, className: 'field-wrap-help-container' }, body);
        };
        return FieldHelp;
    }(react_1.Component));
    ...
    var FieldLabel = /** @class */ (function (_super) {
        ...
        FieldLabel.prototype.render = function () {
            ...
            if (this.props.isEdit && field.requirement) {
                star = entry_js_1.R.span({ className: 'field-wrap-required-star' }, '*');
            }
            else {
                star = '';
            }
            ...
            if (this.props.fieldAlert) {
                if (this.props.isSucessAlert) {
                    alertBody = entry_js_1.R.div({ className: 'fade-in field-wrap-alert field-wrap-alert-success' }, this.props.fieldAlert);
                }
                else {
                    alertBody = entry_js_1.R.div({ className: 'fade-in field-wrap-alert' }, this.props.fieldAlert);
                }
            }
            var body;
            if (field.lang) {
                body = entry_js_1.R.span({ className: 'field-wrap-label-lang' }, field.lang);
            }
            else {
                body = (field.fieldType !== FIELD_18_BUTTON) ? (this.props.labelOwerride || field.name) : '';
            }
            return entry_js_1.R.div({ className: 'field-wrap-label' }, body, star, alertBody);
        };
        return FieldLabel;
    }(react_1.Component));
    ...
    var FieldWrap = /** @class */ (function (_super) {
        ...
        FieldWrap.prototype.render = function () {
            ...
            if (field.fdescription && field.fieldType !== FIELD_8_STATICTEXT) {
                help = React.createElement(FieldHelp, { text: entry_js_1.R.div(null, entry_js_1.R.h4(null, field.name), field.fdescription) });
            }
            var fieldAdmin;
            ...
            if (this.props.isCompact) {
                ...
                var tooltip;
                if (this.state.showtooltip) {
                    tooltip = entry_js_1.R.span({ className: 'field-wrap-tooltip' }, entry_js_1.R.span({ className: 'fa fa-caret-left field-wrap-tooltip-arrow' }), entry_js_1.R.span({ className: 'field-wrap-tooltip-body' }, field.name, (field.lang ? (' (' + field.lang + ')') : undefined), (this.state && this.state.fieldAlert) ? (' (' + this.state.fieldAlert + ')') : ''));
                }
                ...
                return entry_js_1.R.div({ className: className }, label, entry_js_1.R.div({ className: noLabel ? 'field-wrap-value field-wrap-value-no-label' : 'field-wrap-value' }, fieldTypedBody, fieldCustomBody), help, fieldAdmin);
            }
        };
        return FieldWrap;
    }(react_1.Component));
