...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "js/entry.js", "../events/fields_events.js", "../utils.js", "../utils.js", "./field-mixins.js"], factory);
    }
    ...
    utils_js_2.registerFieldClass(FIELD_18_BUTTON, /** @class */ (function (_super) {
        ...
        ButtonField.prototype.render = function () {
            ...
            return entry_js_1.R.button({ className: (this.props.disabled ? 'unclickable field-button' : 'clickable field-button'), onClick: this.onClick }, bIcon, field.name);
        };
        return ButtonField;
