...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "js/entry.js", "react", "../main-frame.js", "../modal.js", "../utils.js", "../utils.js", "./field-mixins.js"], factory);
    }
    ...
    utils_js_2.registerFieldClass(FIELD_21_FILE, /** @class */ (function (_super) {
        ...
        FileField.prototype.render = function () {
            ...
            return entry_js_1.R.a({ className: 'field-file-link', href: utils_js_1.idToFileUrl(fileName), download: true }, fileName ? (fileName.split('/').pop()) : undefined);
        };
        return FileField;
    ...
    var FileFormBody = /** @class */ (function (_super) {
        ...
        FileFormBody.prototype.render = function () {
            ...
            if (this.props.currentFileName) {
                curFile =
                    entry_js_1.R.a({ href: utils_js_1.idToFileUrl(this.props.currentFileName), download: true, target: '_blank', className: 'field-file-link' }, this.props.currentFileName.split('/').pop());
            }
            if (this.state.file) {
                selFile = entry_js_1.R.span({ className: 'small-text' }, utils_js_1.L('FILE_SELECTED', this.state.file.name), "(", (this.state.file.size / 1000).toFixed(2), utils_js_1.L("KILO_BYTES_SHORT"), ")");
            }
            select = entry_js_1.R.button({
            ...
            if (this.props.form.currentData && this.props.form.currentData.id) {
                recIdField = entry_js_1.R.input({ name: "recId", className: 'hidden', defaultValue: this.props.form.currentData.id });
                nodeIdField = entry_js_1.R.input({ name: "nodeId", className: 'hidden', defaultValue: this.props.form.props.node.id });
            }
            var form = entry_js_1.R.form({ ref: function (r) { _this_1.formRef = r; }, encType: "multipart/form-data", className: 'hidden' }, entry_js_1.R.input({ name: "all files", ref: function (r) { _this_1.fileInputRef = r; }, type: 'file', accept: this.props.accept, onChange: this._onChange }), entry_js_1.R.input({ name: "MAX_FILE_SIZE", defaultValue: 30000000 }), entry_js_1.R.input({ name: "fid", defaultValue: field.id }), entry_js_1.R.input({ name: "nid", defaultValue: field.node.id }), recIdField, nodeIdField);
            return entry_js_1.R.div(null, curFile, selFile, form, select);
        };
        return FileFormBody;
    }(react_1.Component));
