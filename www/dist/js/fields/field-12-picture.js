...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../utils.js", "../utils.js", "./field-mixins.js", "../modal.js", "react", "js/entry.js"], factory);
    }
    ...
    utils_js_2.registerFieldClass(FIELD_12_PICTURE, /** @class */ (function (_super) {
        ...
        PictureField.prototype.render = function () {
            ...
            if (this.props.isEdit) {
                ...
                return entry_js_1.R.img({ src: imgUrl, className: "field-readonly-image" });
            }
        };
        return PictureField;
    ...
    var CropperFieldBody = /** @class */ (function (_super) {
        ...
        CropperFieldBody.prototype._onChange = function (e) {
            ...
            if (files.length > 0) {
                ...
                reader.onload = function () {
                    ...
                    var cropperLoader = __syncRequire ? Promise.resolve().then(function () { return __importStar(require('../libs/react-cropper.js')); }) : new Promise(function (resolve_1, reject_1) { require(['../libs/react-cropper.js'], resolve_1, reject_1); }).then(__importStar);
                    selectedImage.onload = function () {
                        cropperLoader.then(function (module) {
                            ...
                            if ((w === selectedImage.width) && (h === selectedImage.height)) {
                                ...
                                utils_js_1.myAlert(entry_js_1.R.div({ className: 'image-copper-popup' }, React.createElement(ReactCropper, {
                                    zoomable: false,
                                ...
                                }), entry_js_1.R.div({ className: 'image-copper-controls' }, entry_js_1.R.button({ className: 'clickable image-copper-crop-btn', onClick: _this_1._cropImage }, utils_js_1.renderIcon('check'), utils_js_1.L('APPLY')), entry_js_1.R.button({ className: 'clickable image-copper-cancel-btn', onClick: _this_1._cancel }, utils_js_1.renderIcon('times'), utils_js_1.L('CANCEL')), entry_js_1.R.div({ className: 'box', style: { margin: '30px auto', width: w, height: h } }, utils_js_1.L('PREVIEW'), entry_js_1.R.div({ className: 'image-copper-preview', style: { width: w, height: h } })))), 1, 0, 1);
                            }
                        });
                    };
                    // @ts-ignore
        ...
        CropperFieldBody.prototype.render = function () {
            ...
            if (this.state.cropResult || this.state.src || this.props.currentPicUrl && this.props.currentPicUrl !== 'images/placeholder_' + field.fieldName + '.png') {
                clrBtn = entry_js_1.R.button({ className: 'clickable toolbtn clear-btn', onClick: this.clear }, utils_js_1.renderIcon('times'));
            }
            if (this.state.src) {
                body = clrBtn;
            }
                ...
                if (this.state.waiting) {
                    ...
                    select = entry_js_1.R.div(null, entry_js_1.R.button({
            ...
            var form = entry_js_1.R.form({ ref: function (r) { _this_1.references.form = r; }, encType: "multipart/form-data", className: 'hidden' }, entry_js_1.R.input({ name: "picture", ref: function (r) { _this_1.references.fileInput = r; }, type: 'file', accept: ".jpg, .jpeg, .png, .gif", onChange: this._onChange }), entry_js_1.R.input({ name: "MAX_FILE_SIZE", defaultValue: 3000000 }), entry_js_1.R.input({ name: "fid", defaultValue: field.id }), entry_js_1.R.input({ name: "nid", defaultValue: field.node.id }), entry_js_1.R.input({ name: "w", ref: function (r) { _this_1.references.w = r; } }), entry_js_1.R.input({ name: "h", ref: function (r) { _this_1.references.h = r; } }), entry_js_1.R.input({ name: "x", ref: function (r) { _this_1.references.x = r; } }), entry_js_1.R.input({ name: "y", ref: function (r) { _this_1.references.y = r; } }));
            return entry_js_1.R.div(null, entry_js_1.R.div(null, preview, body, entry_js_1.R.div({ className: 'small-text' }, utils_js_1.L('RECOMEND_SIZE', recW).replace('%', recH)), form), select);
        };
