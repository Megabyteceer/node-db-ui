...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "react", "./entry.js", "./forms/form-full.js", "./forms/list.js", "./left-bar.js", "./utils.js"], factory);
    }
    ...
    var FormLoaderCog = /** @class */ (function (_super) {
        ...
        FormLoaderCog.prototype.render = function () {
            return entry_js_1.R.div({ className: "fade-in loading-icon" }, utils_js_1.renderIcon('cog fa-spin fa-5x'));
        };
    ...
    var Stage = /** @class */ (function (_super) {
        ...
        Stage.prototype.render = function () {
            ...
            return entry_js_1.R.div({ className: 'stage' }, body);
        };
        return Stage;
    }(react_1.Component));
    exports.Stage = Stage;
