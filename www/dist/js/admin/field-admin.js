...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "js/entry.js", "react", "../events/fields_events.js", "../utils.js", "./admin-event-editor.js", "./admin-utils.js"], factory);
    }
    ...
    var fields_events_js_1 = __importDefault(require("../events/fields_events.js"));
        ...
        FieldAdmin.prototype.render = function () {
            ...
            if (bodyVisible) {
                ...
                if (form.fieldsRefs && form.fieldsRefs[field.fieldName] && form.fieldsRefs[field.fieldName].fieldRef && form.getField(field.fieldName).fieldRef.state.filters) {
                    extendedInfo = entry_js_1.R.div(null, 'filters:', entry_js_1.R.input({
                ...
                body = entry_js_1.R.div({
                ...
                }, utils_js_1.L('FLD_SETTINGS'), entry_js_1.R.b({ className: "admin-form-header" }, field.fieldName), entry_js_1.R.div(null, 'type: ' + field.fieldType + '; id: ' + field.id + '; len:' + field.maxlen), entry_js_1.R.div({
                    ...
                    title: "Move field up"
                }, utils_js_1.renderIcon('arrow-up')), entry_js_1.R.button({
                    className: 'clickable toolbtn admin-form-btn',
                    onClick: function () {
                        var i = field.index;
                ...
                }, utils_js_1.renderIcon('wrench')), entry_js_1.R.span({
                    className: 'clickable admin-form-lock-btn',
                    onClick: this.toggleLock
                }, utils_js_1.renderIcon(this.state.locked ? 'lock' : 'unlock')), entry_js_1.R.button({
                    onClick: function () {
